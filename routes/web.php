...
Route::get('/admin/users/{user}/edit', 'Admin\UsersController@showEditForm');
Route::post('/admin/users/{user}/edit/confirm', 'Admin\UsersController@showEditConfirm');
Route::post('/admin/users/{user}/edit', 'Admin\UsersController@update');
